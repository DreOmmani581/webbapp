...
export const actions = {
    ...
    async actionLogOutLink(context: MainContext) {
        await dispatchRemoveLogIn(context);
        await dispatchRouteLogOutLink(context);
    },
    ...
    actionRouteLogOutLink(context: MainContext) {
        router.push('/');
    },
...
export const dispatchLogOutLink = dispatch(actions.actionLogOutLink);
export const dispatchUserLogOut = dispatch(actions.actionUserLogOut);
export const dispatchRemoveLogIn = dispatch(actions.actionRemoveLogIn);
export const dispatchRouteLoggedIn = dispatch(actions.actionRouteLoggedIn);
export const dispatchRouteLogOut = dispatch(actions.actionRouteLogOut);
export const dispatchRouteLogOutLink = dispatch(actions.actionRouteLogOutLink);
